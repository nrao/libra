...
Container images for LibRA are built using Docker-in-Docker (DinD) via GitLab CI and pushed to [Docker Hub](https://hub.docker.com/u/ardgnrao).
...
| Image | Purpose |
|---|---|
| `ardgnrao/libra-base` | CUDA + system packages (arch-independent) |
...
| `ardgnrao/libra-tests:<arch>` | Test runner (C++ GTest + Python pytest) |
